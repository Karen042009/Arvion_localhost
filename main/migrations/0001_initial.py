# Generated by Django 5.2.3 on 2025-07-10 15:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to=main.models.profile_pic_path, verbose_name='Պրոֆիլի նկար')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to=main.models.face_recognition_image_path, verbose_name='Ճանաչման նկար')),
                ('uploaded_at', models.DateTimeField(auto_now_add=True, verbose_name='Վերբեռնման ամսաթիվ')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='face_images', to=settings.AUTH_USER_MODEL, verbose_name='Օգտատեր')),
            ],
            options={
